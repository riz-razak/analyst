/**
 * Comments System v3 — Supabase-powered FAB + Slide-out Panel
...
(function () {
  ...
  if (!cfg || !cfg.supabaseUrl || !cfg.supabaseAnonKey) {
    console.warn('[comments-v3] Missing ANALYST_COMMENTS_CONFIG — comments disabled');
    return;
  }
  ...
  const i18n = {
    ...
    si: {
      ...
      postError: 'ඔබගේ අදහස පළ කළ නොහැකි විය.',
      guidelines: 'අදහස් ප්\u200Dරතිශෝධනය කෙරේ.',
      charCount: 'ඉතිරිව ඇත',
      justNow: 'දැන්',
      minutesAgo: ' මි. පෙර',
      hoursAgo: ' පැ. පෙර',
  ...
  function renderAuthSection() {
    ...
    if (currentUser) {
      // Signed in — identity bar + compose form
